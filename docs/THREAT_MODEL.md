...
- **Impact if successful:** High — severe price impact if/when a market
  exists
- **Mitigation:** 180,000,000 MRDN (18%) moved into MeridianVesting with a
  10-month cliff and 3-year linear release (see contract 3.x below)
- **Residual risk:** **Open.** The remaining 820,000,000 MRDN (82%) —
...
| # | Risk | Status |
|---|---|---|
| 1.3 | 82% of supply still in single, non-vested address | 🔴 Open |
